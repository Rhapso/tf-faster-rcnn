...
class NWPU_VHR(imdb):
    def __init__(self, image_set):
        ...
        if image_set == 'train':
            self._data_path = os.path.join("/home/fzp/NWPU_VHR","train_split")
        elif image_set == 'val': 
            self._data_path = os.path.join("/home/fzp/NWPU_VHR","val_split")
        ...
        self._xml_path = os.path.join(self._data_path, "label_horizontal")
        self._image_ext = '.jpg'
